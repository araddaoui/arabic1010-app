...
You may use the Service only if you can legally agree to these Terms. If you are under the age of majority where you live, use the Service with the knowledge and supervision of a parent, guardian, teacher, or other responsible adult. Parents and guardians are responsible for supervising a child’s use of the Service and for reviewing any information the child enters into a browser, email client, or other third-party service.
...
- use the Service unlawfully, fraudulently, abusively, or in a way that violates another person’s rights;
- interfere with, disrupt, probe, reverse engineer, scrape, or overload the Service or its hosting infrastructure;
- upload or transmit malware, harmful code, abusive content, or content that you do not have permission to use;
- impersonate another person or misrepresent your affiliation with Arabic1010;
- copy, resell, redistribute, or commercially exploit the Service or its content except as permitted by applicable law or our written permission; or
- use the Service to make decisions for which professional, academic, medical, legal, or other specialist advice is required.

## 5. Educational content and pronunciation

We work to make the lessons, translations, pronunciation guidance, audio, geographic information, and cultural material useful and accurate, but errors, omissions, regional variation, dialect variation, and technical limitations may occur. Arabic1010 does not warrant that every item is complete, current, universally accepted, or suitable for a particular academic, professional, religious, cultural, or personal purpose. You should independently verify consequential information.

Native-speaker audio, speech-recognition features, browser speech features, and other third-party capabilities may vary by device, browser, operating system, connection, accent, and ambient conditions. We do not guarantee that audio playback, recording, waveform comparison, or pronunciation feedback will be available or accurate on every device.
...
The Service may rely on or link to third-party hosting, browsers, speech engines, payment providers, email applications, or other services. Third-party services are governed by their own terms and privacy policies. We are not responsible for third-party availability, security, content, or practices. A link does not constitute endorsement.

## 8. Availability and changes

We may modify, suspend, discontinue, or limit any part of the Service at any time, including for maintenance, security, legal, business, or technical reasons. Features, content, pricing, demonstrations, and availability may change. We do not promise uninterrupted, error-free, or permanently available access.

## 9. Disclaimers

TO THE MAXIMUM EXTENT PERMITTED BY LAW, THE SERVICE IS PROVIDED "AS IS" AND "AS AVAILABLE," WITHOUT WARRANTIES OF ANY KIND, EXPRESS, IMPLIED, OR STATUTORY, INCLUDING WARRANTIES OF MERCHANTABILITY, FITNESS FOR A PARTICULAR PURPOSE, TITLE, NON-INFRINGEMENT, ACCURACY, AVAILABILITY, OR THAT THE SERVICE WILL MEET YOUR EXPECTATIONS.

Nothing in these Terms excludes a warranty or right that cannot lawfully be excluded in your jurisdiction. The Service is not intended to create a professional, fiduciary, employment, educational-enrollment, or advisory relationship.
