...
- an account name, email address, and password for a local demonstration or locally stored account;
...
Information handled by the current release may be used to:

- provide lessons, exercises, progress tracking, review scheduling, badges, and other requested features;
- authenticate a locally stored demonstration or learner account within your browser;
- respond to questions, support requests, feedback, and safety reports;
- maintain, secure, troubleshoot, and improve the Service;
- detect misuse, protect users, and comply with legal obligations; and
- establish, exercise, or defend legal claims where permitted by law.

We do not sell personal information. We do not use learner progress for behavioral advertising in this release.

## 4. Local storage and device controls

The app may use browser local storage or similar client-side storage to preserve accounts, progress, settings, and feedback on your device. This information remains subject to your browser and device controls. You can generally remove it through your browser’s site-data or storage settings. Removing it may sign you out or permanently erase local progress.

Because this information may remain only on your device, Arabic1010 may be unable to restore it if it is deleted, corrupted, lost, or unavailable. Back up information only through methods you trust and do not share credentials with other people.
...
## 6. Audio, speech, and handwriting features

The Service may play bundled audio and may use browser speech or device capabilities for pronunciation practice. In the current release, audio playback and browser speech features are generally processed by the browser or device. The Service should not be treated as a guarantee that a voice recording is never processed by a third-party browser or operating-system provider. Review the applicable browser and device privacy settings and policies.

If a future version introduces server-side voice recording, speech recognition, analytics, cloud storage, or account synchronization, this Policy must be updated before those features are enabled.

## 7. Technical information and hosting

The hosting provider and other infrastructure providers may automatically process technical information such as IP address, browser type, device type, operating system, timestamps, referring pages, approximate location derived from IP, request information, and security logs. This processing may be necessary to deliver, secure, monitor, and troubleshoot the website. Arabic1010 does not control the independent practices of the hosting provider, browser, email provider, or network provider.

We do not intentionally operate advertising trackers or sell technical logs through the current release. If analytics, cookies, pixels, advertising, payment services, or external authentication are added, this Policy must be revised and the relevant choices and disclosures must be provided.
...
We use reasonable measures appropriate to this type of client-side release, but no device, browser, network, storage system, or transmission is completely secure. You are responsible for protecting your device, email account, browser profile, and passwords. Do not reuse the demo password or any password used elsewhere.
...
The Service may link to or depend on third-party services. Their privacy practices are controlled by their own policies, not this Policy. We are not responsible for third-party content, security, availability, or data practices.

## 14. Changes to this Policy

We may update this Policy when the Service, the law, or our data practices change. The updated Policy will be posted through the Service with a revised effective date. Your continued use after an update becomes effective means you acknowledge the updated Policy to the extent permitted by law.
